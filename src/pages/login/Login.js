    ...
    render() {
        ...
        return (
            <div className="auth-page">
                <Container>
                    <Widget className="widget-auth mx-auto" title={<h3 className="mt-0">Lūdzu autorizēties</h3>}>
                        <p className="widget-auth-info">
                            Izmantojiet sava lietotāja vārdu.
                        </p>
                        <form onSubmit={this.doLogin}>
                            ...
                            <div className="bg-widget auth-widget-footer">
                                <Button type="submit" color="danger" className="auth-btn"
                                  ...
                                  {this.props.isFetching ? 'Loading...' : 'Apstiprināt'}
                                </Button>
                                <p className="widget-auth-info mt-4">
                                    Jums nav izveidots lietotājs? Lūdzu sazīnāties ar ceha vadītāju!
                                </p>
                                {/*
                ...
                {new Date().getFullYear()} &copy; Materiālu uzskaites sistēma v1.1.Filbrox - izveidots <a href="https://vlantex.com/" rel="noopener noreferrer" target="_blank">Filbrox Solution</a>.
                </footer>
            </div>
        );
    }
