            ...
            >
                ...
                <ul className={s.nav}>
                    <LinksGroup
                        ...
                        header="INFORMĀCIJAS DĒĻIS"
                        isHeader
                        iconName="flaticon-home"
                        link="/app/main"
                        index="main"
                    />
                    <h5 className={[s.navTitle, s.groupTitle].join(' ')}>UZSKAITES SISTĒMA</h5>
                    {/* */}
                    <LinksGroup
                        onActiveSidebarItemChange={activeItem => this.props.dispatch(changeActiveSidebarItem(activeItem))}
                        activeItem={this.props.activeItem}
                    ...
                    <LinksGroup
                        onActiveSidebarItemChange={activeItem => this.props.dispatch(changeActiveSidebarItem(activeItem))}
                        activeItem={this.props.activeItem}
                        header="Maiņas produktivitāte"
                        isHeader
                        iconName="flaticon-network"
                        link="/app/shiftcharts"
                        index="shiftcharts"
                    />
                    <h5 className={[s.navTitle, s.groupTitle].join(' ')}>Konfigurācija</h5>
                    <LinksGroup
                        onActiveSidebarItemChange={activeItem => this.props.dispatch(changeActiveSidebarItem(activeItem))}
                        activeItem={this.props.activeItem}
                        header="Jauns krājums"
                        isHeader
                        iconName="flaticon-calculator"
                        link="/app/newitem"
                        index="newitem"
