...
import avatar from "../../images/tarasline/zagis_m.jpg";
  ...
  render() {
    return (
      <Navbar className={`d-print-none main-navbar ${s.root}`}>
        ...
        >
          <i className="fa fa-info-circle mr-1" /> Materiālu uzskaites sistēma{" "}
          {/*
          <button
            className="btn-link"
        ...
        <Nav className="ml-md-0 d-flex nav-responsive">
          ...
          >
            <DropdownToggle nav caret style={{ color: "#f4f4f5", padding: 0 }}>
              ...
              <span className={`small ${s.accountCheck}`}>Paku uzskaites sistēma</span>
